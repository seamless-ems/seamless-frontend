...
export const SOCIAL_SQUARE_PRESETS: PresetData[] = [
  {
    ...
    build: (T, bg = "#000000", textColor = "#ffffff", font = "Montserrat") => ({
      ...
      name:        { ...T.name, x: 60, y: 720, color: textColor, fontFamily: font, fontSize: 80, nameFormat: "two-line", width: 960, fontWeight: 800, zIndex: 10 },
...
export const SOCIAL_STORY_PRESETS: PresetData[] = [
  {
    ...
    build: (T, bg = "#000000", textColor = "#ffffff", font = "Montserrat") => ({
      ...
      name:        { ...T.name, x: 90, y: 1150, color: textColor, fontFamily: font, fontSize: 90, textAlign: "center", width: 900, fontWeight: 800, zIndex: 10 },
...
export const NEWSLETTER_PRESETS: PresetData[] = [
  {
    ...
    build: (T, bg = "#ffffff", textColor = "#000000", font = "Montserrat") => ({
      ...
      name:        { ...T.name, x: 400, y: 100, color: textColor, fontFamily: font, fontSize: 60, width: 500, fontWeight: 700, zIndex: 4 },
