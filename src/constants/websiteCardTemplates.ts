...
export const SQUARE_PRESETS_DATA: PresetData[] = [
  {
    ...
    build: (T, bg = "#000000", textColor = "#ffffff", font = "Montserrat") => ({
      ...
      firstName:       { ...T.firstName, x: 36, y: 528, color: textColor, fontFamily: font, fontSize: 55, width: 728, fontWeight: 700, zIndex: 10 },
  ...
  },
  {
    ...
    build: (T, bg = "#000000", textColor = "#ffffff", font = "Montserrat") => ({
      ...
      firstName:   { ...T.firstName, x: 60, y: 321, color: textColor, fontFamily: font, fontSize: 55, width: 480, textAlign: "center", fontWeight: 700, zIndex: 4 },
      lastName:    { ...T.lastName, x: 60, y: 383, color: textColor, fontFamily: font, fontSize: 55, width: 480, textAlign: "center", fontWeight: 700, zIndex: 4 },
...
export const LANDSCAPE_PRESETS_DATA: PresetData[] = [
  ...
  },
  {
    ...
    build: (T, bg = "#000000", textColor = "#ffffff", font = "Montserrat") => ({
      ...
      firstName:   { ...T.firstName, x: 556, y: 130, color: textColor, fontFamily: font, fontSize: 55, width: 308, fontWeight: 700, zIndex: 4 },
      lastName:    { ...T.lastName, x: 556, y: 192, color: textColor, fontFamily: font, fontSize: 55, width: 308, fontWeight: 700, zIndex: 4 },
  ...
  },
  {
    ...
    build: (T, bg = "#000000", textColor = "#ffffff", font = "Montserrat") => ({
      ...
      firstName:       { ...T.firstName, x: 40, y: 321, color: textColor, fontFamily: font, fontSize: 55, width: 680, fontWeight: 800, zIndex: 10 },
      lastName:        { ...T.lastName, x: 40, y: 383, color: textColor, fontFamily: font, fontSize: 55, width: 680, fontWeight: 800, zIndex: 10 },
...
export const PORTRAIT_PRESETS_DATA: PresetData[] = [
  {
    ...
    build: (T, bg = "#000000", textColor = "#ffffff", font = "Montserrat") => ({
      ...
      firstName:       { ...T.firstName, x: 36, y: 521, color: textColor, fontFamily: font, fontSize: 55, width: 528, fontWeight: 700, zIndex: 10 },
      lastName:        { ...T.lastName, x: 36, y: 583, color: textColor, fontFamily: font, fontSize: 55, width: 528, fontWeight: 700, zIndex: 10 },
  ...
  },
  {
    ...
    build: (T, bg = "#000000", textColor = "#ffffff", font = "Montserrat") => ({
      ...
      firstName:   { ...T.firstName, x: 60, y: 361, color: textColor, fontFamily: font, fontSize: 55, width: 480, textAlign: "center", fontWeight: 700, zIndex: 4 },
      lastName:    { ...T.lastName, x: 60, y: 423, color: textColor, fontFamily: font, fontSize: 55, width: 480, textAlign: "center", fontWeight: 700, zIndex: 4 },
  ...
  },
  {
    ...
    build: (T, bg = "#000000", textColor = "#ffffff", font = "Montserrat") => ({
      ...
      firstName:   { ...T.firstName, x: 60, y: 381, color: textColor, fontFamily: font, fontSize: 55, width: 480, textAlign: "center", fontWeight: 700, zIndex: 4 },
      lastName:    { ...T.lastName, x: 60, y: 443, color: textColor, fontFamily: font, fontSize: 55, width: 480, textAlign: "center", fontWeight: 700, zIndex: 4 },
